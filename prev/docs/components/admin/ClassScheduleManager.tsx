...
import { Plus, Edit3, Trash2, Clock, Calendar, Users, Loader2 } from 'lucide-react';
...
export default function ClassScheduleManager({ currentUser }) {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['recurringSchedules'] }),
  });
  ...
  const handleEdit = (schedule) => {
    ...
    setFormData({
      ...
      instructor_email: schedule.instructor_email || currentUser?.email,
      instructor_name: schedule.instructor_name || currentUser?.full_name,
      level: schedule.level || 'all_levels',
        ...
        <div className="flex items-center justify-between">
          ...
          <Dialog open={showDialog} onOpenChange={(open) => {
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle>{editingSchedule ? 'Edit' : 'Add'} Class Schedule</DialogTitle>
              </DialogHeader>
              <div className="space-y-4 pt-4">
                ...
                <Button
                  ...
                  disabled={!formData.class_name || createMutation.isPending || updateMutation.isPending}
          ...
          <div className="space-y-6">
                ...
                <div key={day}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {daySchedules.map((schedule) => (
                      <div
                        key={schedule.id}
                        className="p-4 bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-200 hover:shadow-md transition-shadow"
                      >
            ...
            {schedules.length === 0 && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>No recurring schedules yet. Add your first class!</p>
              </div>
            )}
          </div>
        )}
